...
public class createJobApiJsonDataDrivenTest {
    ...
    @Test(description = "verify create JOB api is able to create Inwarrenty job", groups = { "api", "regression", "smoke","faker","json" },
	...
	public void verifyCreateJobApiTest(createJobPayload payload) {
		given()
		.spec(SpecUtil.requestSpecificationWithAuthAndPayload(Role.FD, payload))
